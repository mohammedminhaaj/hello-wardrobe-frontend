			...
			<nav className='bg-slate-100 px-2 sm:px-4 py-2.5 fixed w-full z-20'>
				<div className='container flex flex-wrap justify-between items-center mx-auto'>
					...
					<div className='flex md:order-2 items-center'>
                        <a><SearchIcon className='mr-3 h-7 w-7 cursor-pointer focus:outline-none'/></a>
                        <a><CartIcon className='h-7 w-7 cursor-pointer focus:outline-none'/></a>
                        <a><AccountIcon className='mx-3 h-7 w-7 cursor-pointer focus:outline-none'/></a>
						{/* <button
							type='button'
					...
					<div
						className={`${showMenu ? '': 'hidden' } justify-between items-center w-full md:flex md:w-auto md:order-1`}>
